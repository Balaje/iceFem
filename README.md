...
The left panel shows the overall profile of the shelf and cavity generated by FreeFem++. The middle and the right panel shows the mesh in the seaward end and a section close to the land, respectively. The distance units are shown in meters (m).
